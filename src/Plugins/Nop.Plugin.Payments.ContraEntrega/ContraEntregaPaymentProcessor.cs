...
namespace Nop.Plugin.Payments.ContraEntrega
{
    public class ContraEntregaPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentContraEntrega/Configure";
        }
        ...
        {
            //settings
            _settingService.DeleteSetting<ContraEntregaPaymentSettings>();

            //locales
            _localizationService.DeletePluginLocaleResource("Plugins.Payment.ContraEntrega.DescriptionText");
            _localizationService.DeletePluginLocaleResource("Plugins.Payment.ContraEntrega.DescriptionText.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payment.ContraEntrega.PaymentMethodDescription");
        ...
        public string PaymentMethodDescription
        {
            ...
            get { return _localizationService.GetResource("Plugins.Payment.ContraEntrega.PaymentMethodDescription"); }
        }

...
namespace Nop.Plugin.Payments.UnaQuincena
{
    public class UnaQuincenaPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentUnaQuincena/Configure";
        }
        ...
        {
            //settings
            _settingService.DeleteSetting<UnaQuincenaPaymentSettings>();

            //locales
            _localizationService.DeletePluginLocaleResource("Plugins.Payment.UnaQuincena.DescriptionText");
            _localizationService.DeletePluginLocaleResource("Plugins.Payment.UnaQuincena.DescriptionText.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payment.UnaQuincena.PaymentMethodDescription");
        ...
        public string PaymentMethodDescription
        {
            ...
            get { return _localizationService.GetResource("Plugins.Payment.UnaQuincena.PaymentMethodDescription"); }
        }

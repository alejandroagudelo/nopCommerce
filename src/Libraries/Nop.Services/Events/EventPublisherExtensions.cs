...
namespace Nop.Services.Events
{
    ...
    public static class EventPublisherExtensions
    {
        ...
        /// <param name="eventPublisher">Event publisher</param>
        /// <param name="entity">Entity</param>
        public static void EntityChageSatatus<T>(this IEventPublisher eventPublisher, T entity) where T : BaseEntity
        {
            eventPublisher.Publish(new EntityChangeStatusEvent<T>(entity));
        }
    }
}